    ...
    <section className="relative min-h-[100vh] flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="max-w-3xl">
          ...
          >
            <Link href="/contact" className="bg-[#f97316] hover:bg-[#ea580c] text-white font-semibold px-8 py-3.5 text-sm transition-colors">
              {h.cta1}
            </Link>
            <a
              ...
              className="border border-white/30 hover:border-[#f97316] text-white font-semibold px-8 py-3.5 text-sm transition-colors flex items-center gap-2"
            >
      ...
      >
        <span className="text-white/40 text-xs uppercase tracking-widest">{h.scroll}</span>
        <motion.div
