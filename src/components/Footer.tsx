      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {t.contact.offices.map((office, i) => (
                <div key={office.name}>
                  ...
                  <a href={`tel:${offices[i].phone}`} className="text-gray-400 hover:text-white text-xs block mt-1 transition-colors">
                    {offices[i].phone}
                  </a>
                  <a href={`mailto:${offices[i].email}`} className="text-gray-400 hover:text-brand text-xs block mt-0.5 transition-colors">
                    {offices[i].email}
                  </a>
                </div>
              ))}
        ...
        <div className="border-t border-[#2a2a2a] mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold px-4 py-2 transition-colors"
          >
